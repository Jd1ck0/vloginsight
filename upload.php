...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['csvfile'])) {
    ...
    $ytHeader = [
        ...
        "Video duration",
        "video1 comments",
        "video1 comment likes",
        "video2 comments",
        "video2 comment likes",
        "video3 comments",
        "video3 comment likes",
        "video4 comments",
        "video4 comment likes",
        "video5 comments",
        "video5 comment likes",
        "video1 total comments",
        "video2 total comments",
        "video3 total comments",
        "video4 total comments",
        "video5 total comments",
        "Hashtags used v1",
        "Hashtags used v2",
        "Hashtags used v3",
        "Hashtags used v4",
    ...
    if ($handle !== false) {
        ...
        $stmt = $con->prepare("INSERT INTO csv_data (file_name, file_data, uploaded_by) VALUES (?, ?, ?)");
        if ($stmt === false) {
